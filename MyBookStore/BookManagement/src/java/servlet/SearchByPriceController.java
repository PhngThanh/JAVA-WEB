...
public class SearchByPriceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookDTO> bookList = bookDAO.getBookListByPrice(Float.parseFloat(minPrice), Float.parseFloat(maxPrice));
            request.setAttribute("BOOKLIST", bookList);
            url = SUCCESS;
        }catch(SQLException e){
            log("SearchByPrice_SQL " + e.getMessage());
        }catch(NamingException e){
            log("SearchByPrice_Naming " + e.getMessage());
        }
        finally{
