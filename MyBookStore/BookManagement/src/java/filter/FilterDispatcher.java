...
public class FilterDispatcher implements Filter {
    ...
    private static final String HOME = "SearchController";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.length() > 0) {
                if (resource.contains(".html") || resource.contains(".png") || resource.contains(".jpg") || resource.contains(".jpeg") 
                        || resource.contains(".js") || resource.contains(".css")) {
                    url = resource;
