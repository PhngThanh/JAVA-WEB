...
public class SearchByCategoryController extends HttpServlet {
    ...
    private final String ALL = "SearchController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (categoryId.equals("All")) {
                ...
                List<BookDTO> bookList = bookDAO.getBookListByCategoryId(categoryId);
                request.setAttribute("BOOKLIST", bookList);
                url = SUCCESS;
            }
        } catch (SQLException e) {
            log("SearchByCategory_SQL " + e.getMessage());
        } catch (NamingException e) {
            log("SearchByCategory_Naming " + e.getMessage());
        } finally {
