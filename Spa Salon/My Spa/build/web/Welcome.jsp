<%-- 
    Document   : Welcome
    Created on : Oct 9, 2019, 2:10:20 PM
    Author     : THANH
--%>
                                ...
                                <div class="nav-collapse collapse">
                                    <ul class="nav" id="topMenu" data-submenu="horizontal">
                                        <li class=" active " style="">
                                            <c:url var="welcomeLink" value="MainServlet">
                                                <c:param name="btnAction" value="Welcome"></c:param>
                                            </c:url>
                                            <a rel="nofollow" href="${welcomeLink}">Welcome</a>
                                        </li><li class="  " style="">
                                            <c:url var="serviceLink" value="MainServlet">
                                                <c:param name="btnAction" value="Service"></c:param>
                                            </c:url>
                                            <a rel="nofollow" href="${serviceLink}">Therapy and Massage</a>
                                        </li><li class="  " style="">
                                            <c:url var="priceLink" value="MainServlet">
                                                <c:param name="btnAction" value="Price"></c:param>
                                            </c:url>
                                            <a rel="nofollow" href="${priceLink}">Price List</a>
                                        </li><li class="  " style="">
                                            <c:url var="empLink" value="MainServlet">
                                                <c:param name="btnAction" value="Employee"></c:param>
                                            </c:url>

                                            <a rel="nofollow" href="${empLink}">Employees</a>
                                        </li><li class="  " style="">
                                            <c:url var="contactLink" value="MainServlet">
                                                <c:param name="btnAction" value="Contact"></c:param>
                                            </c:url>
                                            <a rel="nofollow" href="${contactLink}">Contact us</a>
                                        </li>                </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper ">
                                <div class="content">
                                            ...
                                            <ul class="thumbnails column-article-section">
                                                <c:forEach var="intro" items="${requestScope.INTRO}">
                                                    <li class="span4">
                                                        <div class="img-simple span12 ">
                                                            <div class="image">
                                                                <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314524568923._szw1280h1280_.jpg">
                                                                    <img src="${intro.img}"></a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <h4>
                                                            ...
                                                            <a rel="nofollow" href="${serviceLink}">${intro.title}</a>
                                                        </h4>
                                    ...
                                    <div class="section news">
                                        ...
                                        <div class="content">
                                            <dl class="dl-horizontal">
                                                <c:forEach var="course" items="${requestScope.COURSEINFO}">
                                    ...
                                    <c:set var="emp" value="${requestScope.OWNER}"/>
                                    <div class="section article">
                                        <div class="heading">
                                    ...
                                    <div class="section signature">
                                        <div class="content">
                                            <div class="img-simple span4 signature-image">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/ef/3d/283445307041725935/i283445314527777596._szw1280h1280_.jpg">
                                                        <img src="${emp.img}"></a>
                                                </div>
                                            </div>
